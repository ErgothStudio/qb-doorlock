...
--
--
-- To use adaptation just set authorizedJobs and authorizedGangs
--
--
--
--
...
QB.Doors = {
	...
	-- ILEGAIS
	----------------
	-- KENSHI PORTAS PRINCIPAIS (double doors)
	{
		textCoords = vector3(-171.00, 285.93, 93.96),
		authorizedJobs = { '' },
		...
		doors = {
			{
				objName = 'fluorine4305_dedrest_door_004',
				objCoords = vector3(-171.00, 285.93, 93.96)
			},

			{
				objName = 'fluorine4305_dedrest_door_003',
				objCoords = vector3(-168.77, 285.93, 93.96)
			}
		}
	},
	--
	-- KENSHI ESCRITORIO
	{
		objName = 'fluorine4305_dedrest_door_0027',
		objCoords  = vector3(-149.56, 299.40, 99.02),
		textCoords = vector3(-149.56, 299.40, 98.02),
		authorizedJobs = { '' },
		authorizedGangs = { 'kenshi' },
		locking = false,
		locked = true,
